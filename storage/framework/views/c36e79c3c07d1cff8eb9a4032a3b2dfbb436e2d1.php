...
<?php $__env->startSection('content'); ?>
    <div id="breadcrumbs-wrapper">
        <div class="container">
         ...
         <h5 class="col s4"><a style="font-size:13px;" class="btn waves-effect waves-light pink" href="<?php echo e(route('token_modify')); ?>">TOKEN MODIFICATION</a></h5>
                    <ol class="breadcrumbs col s3 right-align">
